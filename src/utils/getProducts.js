...
const productos = [
    ...
    {id: 2, 
        ...
        description: "Shampoo Elvive Reparación Total Extreme x 400 ml. Repara hasta la última capa: El LAK 1000 penetra hasta 10 capas del cabello para reconstruir las zonas dañadas de la estructura interna del cabello. Elvive Reparación Total Extreme para cabello muy dañado.", 
        category: "cuidado-personal"},
    {id: 3, 
        title:"Toallas Húmedas Huggies Cuidado y Nutrición Oleo Calcáreo x 48 u", 
        price:"5489", 
        imgUrl: toallasHumedasHuggies, 
        description: "Las Toallitas húmedas Huggies® Protección tipo Oleo Calcáreo brindan un cuidado especial para la piel del recién nacido: nutren la piel manteniendo su barrera natural contra resequedad e irritaciones. Su fórmula especialmente diseñada para brindar una protección tipo oleo calcáreo atrae y retiene la humedad natural de la piel.Están hechas con Eco-Fibras*, fibras naturales que limpian delicadamente la piel sensible del bebé. Son hipoalergénicas y no contienen alcohol ni parabenos. (* Fibras de origen natural contenidas en el producto).", 
        category: "cuidado-personal"},
    {id: 4, 
